...
2.  ***Deploy on [`HEROKU`](https://dashboard.heroku.com/new?template=https://github.com/mtaju/LAZACK-WEB2).***
3.  ***Deploy on [`REPLIT`](https://replit.com/github/mtaju/LAZACK-WEB2).***
